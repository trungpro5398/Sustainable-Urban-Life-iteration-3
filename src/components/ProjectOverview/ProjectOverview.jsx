  ...
  return (
    <div className="project-overview-section">
      <div className="description-container">
        ...
        <p>
          Our product champions renewable energy adoption in Victoria, targeting
          eco-aware Greater Melbourne households aged 30-50. We educate and
          empower users towards a sustainable future. With a global rise of over
          260 GW in renewable energy annually, we're committed to making
          Victoria a leader in sustainable growth.
        </p>
        <button
      ...
      <div className="video-container" onClick={handlePlayPause}>
        ...
        {!playing && (
          <div className="play-button">
            {/* You can use a custom play icon or any SVG for the button here */}
            <FaPlay />
          </div>
        )}
      </div>
