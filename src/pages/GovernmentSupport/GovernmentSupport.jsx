    ...
    <div className="government-support">
      ...
      >
        ...
        >
          <CustomPanel
            image={sup1}
            title="Q：Who is eligible for the rebate/subsidy, specifically?"
          >
            <p>
        ...
        <Panel header="Q：How do I claim the VIC solar rebate?" key="2">
        ...
        <Panel header="Q：How Are STCs Calculated?" key="4">
        ...
        <Panel header="Q: What is the Typical System Sizes?" key="5">
          <CustomPanel
            image={sup4}
